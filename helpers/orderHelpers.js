...
const instance = new Razorpay({
  key_id: "rzp_test_GhOSspZtAhvi6S",
  key_secret: "6JU00zZIhZfHTfqtK1osMSVB",
});
...
module.exports = {
    ...
    //             ])
    //                 .then((total) => {
    //                     console.log(total,'2222222222222');
            ...
            return new Promise((resolve, reject) => {
                cartModel.Cart.aggregate([
                    ...
                    },
                    {
                        $lookup: {
                            from: "products",
                            localField: "cartItems.productId", // Updated field path
                            foreignField: "_id",
                            as: "carted"
                        }
                    },
  ...
  verifyPayment: (details) => {
    return new Promise((resolve, reject) => {
      try {
        ...
        let hmac = crypto.createHmac("sha256", '6JU00zZIhZfHTfqtK1osMSVB');
        hmac.update(
